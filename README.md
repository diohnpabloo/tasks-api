...
Nas rotas que recebem o /:id, além de validar se o id existe no banco de dados, retornar a requisição com uma mensagem informando que o registro não existe.Tarefas
Use este checklist para ajudar a organizar a sua entrega

## Guia detalhado de implementação

Para seguir um passo a passo completo com checklist, comandos e exemplos pequenos de código, consulte o arquivo [DEVELOPMENT.md](DEVELOPMENT.md).
